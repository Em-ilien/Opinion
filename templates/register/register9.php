...
<body>
  ...
  <form action="?page=register/10" method="post" Class="corps">
    <h2 class="sous-titre">Inscription réussie </h2>
    <p class="text-info1">
      Votre inscription a été validée.
      Vous pouvez à tout moment demander à supprimer votre compte et vos données personnelles en envoyant un courriel à
